...
void print_ff_osd_menu()
{
    ...
    Serial.println("  e   toggle FF OSD enable");
...
void print_ff_osd_i2c_protocol()
{
    ...
    if (settings.ff_osd_config.i2c_protocol)
        Serial.println("FlashFloppy");
    else
        Serial.println("LCD HD44780");
}
...
void print_ff_osd_cols()
{
    ...
    Serial.println(settings.ff_osd_config.i2c_protocol ? ff_osd_display.cols : settings.ff_osd_config.cols, DEC);
}
