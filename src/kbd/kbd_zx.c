/**
 * kbd_zx.c - Universal to ZX Spectrum keyboard mapping
 *
 * Based on zx-rgbi-to-vga-hdmi_gotek-osd and RGB_TO_VGA_HDMI_25
 * reference projects mapping scheme.
 *
...
static inline void apply_zx_entry(zx_kb_state_t* zx, const zx_key_map_t* e)
{
