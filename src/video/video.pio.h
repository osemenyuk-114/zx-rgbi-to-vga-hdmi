...
static const uint16_t pio_capture_0_program_instructions[] = {
    ...
    0xa042, //  0: nop
    0x4008, //  1: in     pins, 8
    0x8060, //  2: push   iffull block
    0xa842, //  3: nop                           [8]
    0x00c1, //  4: jmp    pin, 1
    0x4008, //  5: in     pins, 8
    0x8060, //  6: push   iffull block
    0x00c0, //  7: jmp    pin, 0
    0x00c0, //  8: jmp    pin, 0
    0x00c0, //  9: jmp    pin, 0
    0x00c0, // 10: jmp    pin, 0
...
#define pio_capture_1_offset_wait_f_low_1 2u
#define pio_capture_1_offset_wait_f_high_1 4u
#define pio_capture_1_offset_divider2 8u
#define pio_capture_1_offset_wait_f_low_2 9u
#define pio_capture_1_offset_wait_f_high_2 12u
...
#define pio_dvi_conv_wrap_target 0
#define pio_dvi_conv_wrap 7
#define pio_dvi_conv_pio_version 0

static const uint16_t pio_dvi_conv_program_instructions[] = {
            //     .wrap_target
    0x80a0, //  0: pull   block
    0x40e8, //  1: in     osr, 8
    0x4034, //  2: in     x, 20
...
#if !PICO_NO_HARDWARE
static const struct pio_program pio_dvi_conv_program = {
    .instructions = pio_dvi_conv_program_instructions,
    .length = 8,
    .origin = -1,
    .pio_version = pio_dvi_conv_pio_version,
#if PICO_PIO_VERSION > 0
    .used_gpio_ranges = 0x0
#endif
};

static inline pio_sm_config pio_dvi_conv_program_get_default_config(uint offset) {
    pio_sm_config c = pio_get_default_sm_config();
    sm_config_set_wrap(&c, offset + pio_dvi_conv_wrap_target, offset + pio_dvi_conv_wrap);
    return c;
}
#endif
